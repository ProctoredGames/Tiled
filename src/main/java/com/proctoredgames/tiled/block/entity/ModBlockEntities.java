...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<SmallTileLayerBE> SMALL_TILE_LAYER_BE =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(Tiled.MOD_ID, "small_tile_layer_be"),
    ...
    public static final BlockEntityType<TileLayerBE> TILE_LAYER_BE =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(Tiled.MOD_ID, "tile_layer_be"),
