...
public class ModItems {
    ...
    public static final Item WHITE_CONCRETE_TILE = registerItem("white_concrete_tile", new Item(new Item.Settings()));
    public static final Item ORANGE_CONCRETE_TILE = registerItem("orange_concrete_tile", new Item(new Item.Settings()));
    public static final Item MAGENTA_CONCRETE_TILE = registerItem("magenta_concrete_tile", new Item(new Item.Settings()));
    public static final Item LIGHT_BLUE_CONCRETE_TILE = registerItem("light_blue_concrete_tile", new Item(new Item.Settings()));
    public static final Item YELLOW_CONCRETE_TILE = registerItem("yellow_concrete_tile", new Item(new Item.Settings()));
    public static final Item LIME_CONCRETE_TILE = registerItem("lime_concrete_tile", new Item(new Item.Settings()));
    public static final Item PINK_CONCRETE_TILE = registerItem("pink_concrete_tile", new Item(new Item.Settings()));
    public static final Item GRAY_CONCRETE_TILE = registerItem("gray_concrete_tile", new Item(new Item.Settings()));
    public static final Item LIGHT_GRAY_CONCRETE_TILE = registerItem("light_gray_concrete_tile", new Item(new Item.Settings()));
    public static final Item CYAN_CONCRETE_TILE = registerItem("cyan_concrete_tile", new Item(new Item.Settings()));
    public static final Item PURPLE_CONCRETE_TILE = registerItem("purple_concrete_tile", new Item(new Item.Settings()));
    public static final Item BLUE_CONCRETE_TILE = registerItem("blue_concrete_tile", new Item(new Item.Settings()));
    public static final Item BROWN_CONCRETE_TILE = registerItem("brown_concrete_tile", new Item(new Item.Settings()));
    public static final Item GREEN_CONCRETE_TILE = registerItem("green_concrete_tile", new Item(new Item.Settings()));
    public static final Item RED_CONCRETE_TILE = registerItem("red_concrete_tile", new Item(new Item.Settings()));
    public static final Item BLACK_CONCRETE_TILE = registerItem("black_concrete_tile", new Item(new Item.Settings()));
