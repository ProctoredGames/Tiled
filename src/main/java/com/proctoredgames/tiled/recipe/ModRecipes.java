...
//    public static final RecipeSerializer<TilingTableRecipe> TILING_TABLE_SERIALIZER = Registry.register(
//            Registries.RECIPE_SERIALIZER, Identifier.of(Tiled.MOD_ID. "tiling_table"),
//                new TilingTableRecipe.Serializer());
